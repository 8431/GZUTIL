...
public class TimeUtil {
    ...
    private static SimpleDateFormat datetime = new SimpleDateFormat(
	            "yyyy-MM-dd HH:mm:ss");
    // 设置时间格式年月日小时分钟秒
    private static SimpleDateFormat datetimenum = new SimpleDateFormat(
            "yyyyMMdHHmmss");
 ...
 // ****************************当前时间相关****************************
    ...
    public static String getCurrentTimeNumByDay() {
        String time = datetimenum.format(new Date(System.currentTimeMillis()));
        return time;
    }
 ...
 // ****************************Date转换为String****************************
    ...
    public static void main(String[] args) {
		//System.out.println("获取当前的时间是："+getCurrentTimeByDay());
    	
    	//System.out.println("我想要格式的当前时间是"+getCurrentTime("yyy-MM-dd HH:MM:SS"));
    	
//    	try {
//			System.out.println(pStringToDate( "2017-08-22 19:18:10","yyyy-MM-dd HH:MM:SS"));
//		} catch (ParseException e) {
