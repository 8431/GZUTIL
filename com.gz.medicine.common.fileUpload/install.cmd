...
set PATHP=%PATH%
set PATH=%PATH%;%M2_HOME%\bin;%ANT_HOME%\bin;%JAVA_HOME%\bin
...
mvn clean install -DconfigInstance=%configInstance% -Dmaven.test.skip=%skipTest% -Dassembly.skipAssembly=true
